...
describe Camera do
  ...
  context '#target' do
    it 'should center camera' do
      ...
      subject.rectangle.x.should == 40
      subject.rectangle.y.should == 40
    end
    ...
    it 'should not show level end' do
      ...
      subject.rectangle.x.should == 130
      subject.rectangle.y.should == 130


      object = double(x: 2, y: 3)
      subject.target(object)

      subject.rectangle.x.should == 0
      subject.rectangle.y.should == 0
    end
  end
